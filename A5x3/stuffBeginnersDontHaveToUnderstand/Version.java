...
public class Version implements Serializable {
    ...
    final static private long encodedV2 =      2___00002_011___2025_12_04__01L; // "V2" ::= V^2 = (class) Version Version  resp. Version of the class Version
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
    //
    static {
    ...
    /**
     * The method {@link #getDecodedV2()} delivers the code version of the Version class itself as reground/readable String.
    ...
    /**
     * The method {@link #getEncodedVersion()} delivers the encoded (client) version number.
     * 
     * @return version
     */
