...
public class Herald implements Serializable {
    ...
    final static private long encodedVersion = 2___00001_006___2025_12_19__01L;
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
    ...
    public static void proclaimMessage( final String message ){
        System.err.flush();
        System.out.flush();             // NICHT nötig, kommt eh am Ende
    ...
    public static void proclaimError( final String message ){
        System.out.flush();
        System.err.flush();             // NICHT nötig, kommt eh am Ende
