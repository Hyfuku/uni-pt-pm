 ...
 * (c)&(p) 2007-2031<br />
 * Idea & Implementation : Michael Schäfers.<br />
...
public class Card implements Comparable<Card> {
    ...
    final static private long encodedVersion = 2___00001_007___2025_12_10__01L;
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
     ...
     *         <td>Da es die &quot;Default-Denke&quot; bei einem enum ist, sollte es eigentlich nicht extra erwähnt werden müssen.
     *             Wie auch immer, die Werte des enum {@link #Suit} genügen den Anforderungen einer Ordinal-Skala.
     *         </td>
     *     </tr>
     *     <tr>
     *         <td valign="top">&bull;</td>
     *         <td>Die Implementierung der (Spiel-)Karte (Klasse: {@link Card})
     *             ist auf den Anwendungszweck <strong>Poker</strong> (konkret: <strong>Texas Hold’em</strong>) abgestimmt.
     *             In der Konsequenz gilt die Bridge-Ordnung: "CLUB < DIAMOND < HEART < SPADES"
     *             (die den Anforderungen einer Ordinal-Skale genügt) für die Karten-Farben (Enum: {@link #Suit}).
     *         </td>
     *     </tr>
     * </table>
     */
     ...
     * <br />
     * Bemerkung:<br />
     * Da es die &quot;Default-Denke&quot; bei einem enum ist, sollte es eigentlich nicht extra erwähnt werden müssen.
     * Wie auch immer, die Werte des enum {@link #Rank} genügen den Anforderungen einer Ordinal-Skala.
     */
    public enum Rank {
    ...
    /**
     * Die (Sub-)Klasse {@link Constant} enthält wichtige Konstanten.<br />
     * Die einzelnen (Spiel-)Kartenwerte, wie z.B. DJ oder HQ, genügen nicht den Anforderungen einer Ordinal-Skala,
     * sondern genügen nur den Anforderungen einer Nominal-Skala.
     * Daher wurde bewusst kein enum verwendet, sondern die Kartenwerte werden einzeln als Konstanten aufgezählt.
     */
